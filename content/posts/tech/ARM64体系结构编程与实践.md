...
&ensp;ARM64处理器实现弱一致性内存模型，使用内存屏障指令实现同步访问，内存屏障指令原则： <br>
...
&ensp;task_struct数据结构描述一个进程控制块(Processing Control Block PCB)
...
&ensp;ARM64体系结构系统调用SVC，应用程序通过SVC指令自陷到操作系统内核中，即陷入EL1
